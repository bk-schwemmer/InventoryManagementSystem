...
/**
 * Allows user to create a new part in inventory
 *
...
public class AddPart {
    ...
    /**
     * Saves all data entered on current screen if valid and pushes the part to inventory
     *
